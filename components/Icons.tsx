...
export const TrailBadgeOnTheWayIcon: React.FC<IconProps> = ({ className }) => (
  <img src="/img/On-the-Way.png" alt="Auf dem Weg Abzeichen" className={className} />
);

export const TrailBadge10Icon: React.FC<IconProps> = ({ className }) => (
  <img src="/img/10er-Trail.png" alt="10 Trails Abzeichen" className={className} />
);

export const TrailBadge50Icon: React.FC<IconProps> = ({ className }) => (
  <img src="/img/50er-Trail.png" alt="50 Trails Abzeichen" className={className} />
);

export const TrailBadge100Icon: React.FC<IconProps> = ({ className }) => (
  <img src="/img/100er-Trail.png" alt="100 Trails Abzeichen" className={className} />
);

export const TrailBadge500Icon: React.FC<IconProps> = ({ className }) => (
  <img src="/img/500er-Trail.png" alt="500 Trails Abzeichen" className={className} />
);
// --- SEMINAR/EVENT-ABZEICHEN (lokal eingebunden) ---
export const SeminarEventPatchIcon: React.FC<IconProps> = ({ className }) => (
  <img src="/img/Workshop-und-Seminare-und-Events.png" alt="Seminar und Event Abzeichen" className={className} />
);
