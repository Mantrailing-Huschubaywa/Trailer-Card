...
interface TransactionTypeSelectionModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSelectType: (type: 'Mantrailing' | 'customRecharge' | 'customDebit' | 'customSeminarDebit', selectedDog?: Dog) => void;
...
const TransactionTypeSelectionModal: React.FC<TransactionTypeSelectionModalProps> = ({
  ...
  const handleSelect = (type: 'Mantrailing' | 'customRecharge' | 'customDebit' | 'customSeminarDebit', dog?: Dog) => {
